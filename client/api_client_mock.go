...
func (m *MockApiClientInterface) EnvironmentUpdateTags(id string, payload EnvironmentTags) (Environment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnvironmentUpdateTags", id, payload)
	ret0, _ := ret[0].(Environment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockApiClientInterfaceMockRecorder) EnvironmentUpdateTags(id, payload any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnvironmentUpdateTags", reflect.TypeOf((*MockApiClientInterface)(nil).EnvironmentUpdateTags), id, payload)
}
