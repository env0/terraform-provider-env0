...
- **token_id** (String) The token id used for private git repos or for integration with GitLab, you can get it by using data resource on existing template or contact us
