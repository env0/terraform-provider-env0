...
func TestUnitTemplateResource(t *testing.T) {
	...
	t.Run("vcs_connection_id does not drift on backend-populated github_installation_id", func(t *testing.T) {
		template := client.Template{
			Id:               "id0",
			Name:             "template0",
			Repository:       "env0/repo",
	...
	t.Run("github_installation_id does not drift on backend-populated vcs_connection_id", func(t *testing.T) {
		template := client.Template{
			Id:                   "id0",
			Name:                 "template0",
			Repository:           "env0/repo",
			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr(resourceFullName, "id", template.Id),
						resource.TestCheckResourceAttr(resourceFullName, "name", template.Name),
						resource.TestCheckResourceAttr(resourceFullName, "github_installation_id", "456"),
						resource.TestCheckNoResourceAttr(resourceFullName, "vcs_connection_id"),
					),
				},
			},
		}
	...
	t.Run("vcs_connection_id suppresses backend-populated github_installation_id", func(t *testing.T) {
		template := client.Template{
			Id:               "id0",
			Name:             "template0",
			Repository:       "env0/repo",
	...
	t.Run("vcs_connection_id suppresses backend-populated bitbucket_client_key", func(t *testing.T) {
		template := client.Template{
			Id:               "id0",
			Name:             "template0",
			Repository:       "env0/repo",
	...
	t.Run("vcs_connection_id suppresses backend-populated token_id and is_gitlab", func(t *testing.T) {
		template := client.Template{
			Id:               "id0",
			Name:             "template0",
			Repository:       "env0/repo",
	...
	t.Run("vcs_connection_id suppresses backend-populated token_id and is_azure_devops", func(t *testing.T) {
		template := client.Template{
			Id:               "id0",
			Name:             "template0",
			Repository:       "env0/repo",
