	...
	for _, templateUseCase := range templateUseCases {
		t.Run("Full "+templateUseCase.vcs+" template (without SSH keys)", func(t *testing.T) {
			...
			templateCreatePayload := client.TemplateCreatePayload{
				...
				GithubInstallationId: client.NullInt(templateUseCase.template.GithubInstallationId),
				IsGitlabEnterprise:   templateUseCase.template.IsGitlabEnterprise,
				IsGitLab:             templateUseCase.template.TokenId != "",
				GitlabProjectId:      gitlabProjectId,
				TokenId:              client.NullString(templateUseCase.template.TokenId),
				...
				BitbucketClientKey:   client.NullString(templateUseCase.template.BitbucketClientKey),
			...
			updateTemplateCreateTemplate := client.TemplateCreatePayload{
				...
				GithubInstallationId: client.NullInt(templateUseCase.updatedTemplate.GithubInstallationId),
				...
				TokenId:              client.NullString(templateUseCase.updatedTemplate.TokenId),
				...
				BitbucketClientKey:   client.NullString(templateUseCase.updatedTemplate.BitbucketClientKey),
