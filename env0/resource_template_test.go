...
func TestUnitTemplateResourceFull(t *testing.T) {
...
func TestUnitTemplateResourceBasic(t *testing.T) {
	template := client.Template{
		Id:         "id0",
		Name:       "template0",
		Repository: "env0/repo",
...
func fullTemplateResourceCheck(resourceFullName string, template client.Template) resource.TestCheckFunc {
...
func fullTemplateResourceConfig(resourceType string, resourceName string, template client.Template) string {
...
func basicTemplateResourceConfig(resourceType string, resourceName string, template client.Template) string {
	return resourceConfigCreate(resourceType, resourceName, map[string]interface{}{
		"name":       template.Name,
		"repository": template.Repository,
	})
...
func sshKeyTemplateResourceConfig(name string, repository string, sshKey1 client.TemplateSshKey, sshKey2 client.TemplateSshKey) string {
	return fmt.Sprintf(`
